...
# CNN model construct
model = Sequential([
    Conv2D(32, (7, 7),padding='same', activation='relu', input_shape=(32, 32, 3)),
    MaxPooling2D((2, 2)),
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='PuBuGn', xticklabels=class_labels, yticklabels=class_labels)
